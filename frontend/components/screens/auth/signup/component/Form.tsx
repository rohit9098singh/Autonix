    ...
    <div className="relative w-full max-w-md mx-auto ">
      <div className="relative">
        ...
        <div className="text-center mb-2">
          ...
          <h1 className="text-xl font-bold bg-gradient-to-r from-gray-900 via-emerald-800 to-blue-800 bg-clip-text text-transparent ">
            Create Account
          </h1>
        </div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
                  ...
                  <FormControl>
                    <div className="relative group">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          className="pl-12 pr-4 py-3 bg-gray-50/50 border-2 border-gray-200 rounded-xl focus:border-emerald-500 focus:bg-white transition-all duration-300 hover:border-gray-300"
            ...
            {/* Phone Field (Optional) - Made more compact */}
            <FormField
              control={form.control}
              name="phone"
              render={({ field }) => (
                <FormItem className="space-y-1">
                  ...
                  <FormControl>
                    <div className="relative group">
                      ...
                      <div className="relative">
                        <Phone className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 transition-colors group-focus-within:text-indigo-500" />
                        <Input
                          type="tel"
                          className="pl-12 pr-4 py-3 bg-gray-50/50 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:bg-white transition-all duration-300 hover:border-gray-300"
